...
(function ($) {
    ...
    KEditor.components['testkiki'] = {
        getContent: function (component, keditor) {
            flog('getContent "testkiki" component, component');
        ...
        settingTitle: 'Testkiki Settings',
...
(function ($) {
    ...
    KEditor.components['photo'] = {
        ...
        settingTitle: 'Foto Einstellungen',
        ...
        initSettingForm: function (form, keditor) {
            ...
            form.append(
                ...
                */
                ...
                /*
                '   <div class="form-group">' +
                '       <label for="photo-responsive" class="col-sm-12">Responsive Bild</label>' +
                '       <div class="col-sm-12">' +
